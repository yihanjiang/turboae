...
def t_dist3(in_array1, in_array2, sigma = 1.0):
    """
    ...
    # sigma = 1.0
    distance = np.sum(np.log(1+ (in_array1 - in_array2)*(in_array1 - in_array2)/(1.0*1)))

    #distance = 2.0 math.log(+3)
...
def t_dist5(in_array1, in_array2):
    ...
    # sigma = 1.0
    distance = np.sum(np.log(1+ (in_array1 - in_array2)*(in_array1 - in_array2)/(1.0*4)))
